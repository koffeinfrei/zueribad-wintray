...
namespace Koffeinfrei.Zueribad.Core
{
    public static class ColorExtensions
    {
        ...
        public static Color FromHexCodeAndAlpha(string hexCode, string alpha)
        {
            ...
            int r = IntegerExtensions.FromHex(hexCode.Substring(0, 2));
            int g = IntegerExtensions.FromHex(hexCode.Substring(2, 2));
            int b = IntegerExtensions.FromHex(hexCode.Substring(4));
